...
function GenerateVagrantProvisioning() {
	...
	// Check that foundation version is either 7.2.0.beta or 7.2.0.final
	if (foundationVersion.substring(0,6) != "7.2.0.") {
		alert("Please note that only versions 7.2.0.beta and 7.2.0.final of foundation have been tested compatible with the scripts generated by this app.\n\n"+
			"Foundation versions 7.3.0.beta, 6.11.5.final and 6.11.5.beta will not work with the current scripts.\n\n"+
			"Please see the Docs or the Woki for a complete list of tested products and versions.\n\n" +
